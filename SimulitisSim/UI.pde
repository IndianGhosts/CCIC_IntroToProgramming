public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, citySize - (citySize*0.4), citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Current Infections: " + infected, citySize - (citySize*0.2), citySize - 25);
    
    text("Recovered: " + recovered, citySize - (citySize*0.6), citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Dead: " + dead, citySize - (citySize*0.8), citySize - 25);
  }
}
